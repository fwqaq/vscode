...
<body>
	...
	<form id="Form1" name="Form1"
		...
		商品类型:<select name="cid">
		<option value="">不限</option>
		<c:forEach items="${Category }" var="cat">
		<option value="${cat.cid }" name="cid">${cat.cname }</option>
		</c:forEach>
				</select>&nbsp;&nbsp;
						...
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<tr onmouseover="this.style.backgroundColor = 'white'"
								...
								<td align="center" style="HEIGHT: 22px"><a
									href="${pageContext.request.contextPath}/updateShow?pid=${pro.pid }">
										<img
										src="${pageContext.request.contextPath}/images/i_edit.gif"
										border="0" style="CURSOR: hand">
								</a></td>
								
								<td align="center" style="HEIGHT: 22px"><a href="javascript:void(0);" onclick="delProduct('${pro.pid}')">
								<img src="${pageContext.request.contextPath}/images/i_del.gif"
										width="16" height="8" border="0" style="CURSOR: hand">
								</a></td>
							</tr>
						</c:forEach>
						</table>
